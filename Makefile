...
tag: ## Create a git tag (use VERSION=v0.0.1)
...
push-tag: ## Push tag to remote (use VERSION=v0.0.1)
	@echo "Pushing tag $(VERSION)..."
	git push origin $(VERSION)
	git push origin main
	@echo "Tag $(VERSION) pushed!"

release: all ## Full release: build, test, commit, tag, and push (use VERSION=v0.0.1)
